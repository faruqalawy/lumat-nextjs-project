export default function ProductDescription({ item }) {
  ...
  return (
    <div className="mt-3 md:mt-6 l:m-0">
      <h1 className="text-center lg:text-left font-bold text-xl md:text-2xl">
        {item.name}
      </h1>
      <p className="text-center lg:text-left font-openSans font-light md:text-lg lg:text-lg mb-4 md:mb-6">
        {item.description}
      </p>
